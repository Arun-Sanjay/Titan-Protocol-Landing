...
export const TITAN_PREVIEW_IMAGE_PATH = "/images/TitanOSdash.jpg"

export const TITAN_PRODUCT_IMAGES = [
  { src: "/images/product/First.jpg", alt: "Titan Protocol OS — Overview" },
  { src: "/images/product/main-dash.jpg", alt: "Titan Protocol OS — Main Dashboard" },
  { src: "/images/product/analytics-page.jpg", alt: "Titan Protocol OS — Analytics" },
  { src: "/images/product/body-page.jpg", alt: "Titan Protocol OS — Body Tracking" },
  { src: "/images/product/mind-page.jpg", alt: "Titan Protocol OS — Mind" },
  { src: "/images/product/money-page.jpg", alt: "Titan Protocol OS — Money" },
]
...
export const TITAN_SUPPORT_NOTE = "If you need help accessing your build, contact Titan Protocol support."
